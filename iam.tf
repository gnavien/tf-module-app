    ...
    "Statement": [
      {
        ...
        "Resource": "arn:aws:ssm:us-east-1:590184141824:parameter/roboshop-${var.env}.${var.component}.*" # location to get parameter AWS Systems Manager-->Parameter Store-->roboshop.dev.cart.redis_host-->Overview
      }
    ]
  })
}
